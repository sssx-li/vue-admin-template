...
import { ITableList } from '@/service/api/types';
...
const contentData = {
  ...
  [`onGet::${ContentApis.DASHBOARD}`]: (params: any) => {
  ...
  [`onPut::${ContentApis.DASHBOARD}`]: (params: any) => {
  ...
  [`onDelete::${ContentApis.DASHBOARD}`]: (id: string | number) => {
